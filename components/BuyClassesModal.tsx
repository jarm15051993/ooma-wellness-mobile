...
type Props = {
  visible: boolean
  // If set, auto-books this class after a successful purchase
  pendingClassId?: string | null
  onClose: () => void
  onPurchaseAndBooked?: () => void  // called after purchase + auto-book
  onPurchaseOnly?: () => void       // called after purchase when no pendingClassId
}
...
export default function BuyClassesModal({
  ...
  async function handlePurchase(packageId: string) {
    ...
    try {
      ...
      // Auto-book the class that triggered this modal
      if (pendingClassId) {
        try {
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerRow}>
            <View>
              ...
              {pendingClassId ? (
                <Text style={styles.subtitle}>Purchase a pack to book this class</Text>
              ) : (
                ...
                >
                  {isLoading
                    ...
                    : <Text style={styles.buyBtnText}>
                        {pendingClassId ? 'BUY & BOOK CLASS' : 'BUY NOW'}
                      </Text>
                  }
                </TouchableOpacity>
              </View>
